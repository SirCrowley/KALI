      ...
      <aside class="main-sidebar">
		...
		<li><a href="../achats/achatssup.php"><i class="fa fa-minus-square-o"></i> Supprimer</a></li>
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="./produitsvue.php"><i class="fa fa-eye"></i> Voir</a></li>
                <li><a href="./produitsadd.php"><i class="fa fa-plus-square-o"></i> Ajouter</a></li>
