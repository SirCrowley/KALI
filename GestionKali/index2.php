      ...
      <aside class="main-sidebar">
		...
		<li><a href="./pages/clients/clientssup.php"><i class="fa fa-minus-square-o"></i> Supprimer</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="./pages/achats/achatsvue.php"><i class="fa fa-eye"></i> Voir</a></li>
                <li><a href="./pages/achats/achatsadd.php"><i class="fa fa-plus-square-o"></i> Ajouter</a></li>
		<li><a href="./pages/achats/achatssup.php"><i class="fa fa-minus-square-o"></i> Supprimer</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
